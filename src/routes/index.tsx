...
const sections: Section[] = [
  ...
  },
  {
    ...
    icon: Code2,
    description: "Public site, app and development tools.",
    tiles: [
      {
        key: "site",
      ...
      },
      {
        ...
        icon: Code2,
        href: "https://supabase.com/dashboard/project/kcezuzzefouwqbgbxuog",
        logoSlug: "supabase",
        brandColor: "3ecf8e",
      },
      {
        key: "github",
        title: "GitHub",
        description: "Open the desktop app repository.",
        icon: Code2,
        href: "https://github.com/ascendfba/dispatch-console-desktop",
        logoSlug: "github",
        brandColor: "181717",
      },
    ],
